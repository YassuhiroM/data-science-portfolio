...
Quick code to clean up usually not 'data-science ready' to use open data / public datasets. In my  first projects, I struggled to clean up data usually formatted for people consumption rather than data science tools. 
...
### 3. SnowFlake Notebook / Simultaneous coding with Python and SQL | *Notebook de Snowflake: Codificación simultánea con Python y SQL*
- ***SnowFlake Notebook Exercise (simultaneous Python and SQL coding)   - published in Aug 2025***  
